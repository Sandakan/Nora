...
const SongStat = React.memo((props: SongStatProp) => {
  ...
  return (
    <div
      className={`stat appear-from-bottom flex min-h-[6rems] w-60 flex-row items-center justify-between rounded-lg bg-background-color-2/70 p-2 text-font-color-black backdrop-blur-md dark:bg-dark-background-color-2/70 dark:text-font-color-white ${className}`}
    >
