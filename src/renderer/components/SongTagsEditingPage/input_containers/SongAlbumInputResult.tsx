...
const SongAlbumInputResult = (props: Props) => {
  ...
  return (
    <button
      ...
      className="flex w-full cursor-pointer border-b-[1px] border-background-color-2 py-2 px-4 text-left font-light outline-1 outline-offset-1 last:border-b-0 only:border-b-0 hover:bg-background-color-2 focus-visible:!outline dark:border-dark-background-color-2 dark:hover:bg-dark-background-color-2"
      onClick={() => {
