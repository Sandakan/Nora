...
const SideBarItem = (props: SideBarItems) => {
  return (
    <li
      ...
      tabIndex={0}
    >
      <span className="material-icons-round icon mr-5 text-3xl !font-normal">
        {props.icon}
      </span>
