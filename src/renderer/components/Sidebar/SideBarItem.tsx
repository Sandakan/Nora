...
const SideBarItem = (props: SideBarItems) => {
  return (
    <li
      ...
      } mb-2 flex !h-12 w-[95%] !min-w-[3rem] cursor-pointer items-center rounded-r-3xl bg-[transparent] pl-4 text-2xl text-font-color-black outline-1 outline-offset-2 transition-[background] duration-300 hover:bg-background-color-1 focus-visible:!outline dark:text-font-color-white dark:hover:bg-dark-background-color-1 ${
        props.isActive &&
