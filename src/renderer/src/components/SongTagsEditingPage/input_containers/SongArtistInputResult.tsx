...
const SongArtistInputResult = (props: Props) => {
  ...
  return (
    <button
      ...
      className="border-background-color-2 odd:bg-background-color-2/10 hover:bg-background-color-2 dark:border-dark-background-color-2 dark:odd:bg-dark-background-color-2/10 dark:hover:bg-dark-background-color-2 flex w-full cursor-pointer border-b-[1px] px-4 py-2 font-light outline outline-offset-1 last:border-b-0 only:border-b-0 focus-visible:outline!"
      onClick={() => {
