    ...
    <div className="song-artwork-container relative mr-8 h-40 w-40 overflow-hidden">
      ...
      <div className="absolute top-1/2 left-1/2 flex w-full -translate-x-1/2 -translate-y-1/2 justify-around px-4">
        <Button
          ...
          className="artwork-update-btn mr-0 aspect-square rounded-full border-none bg-[hsla(0,0%,0%,0.5)]! outline outline-offset-1 transition-[background]! hover:bg-[hsla(0,0%,0%,0.8)]! focus-visible:outline! dark:bg-[hsla(0,0%,0%,0.5)]! dark:hover:bg-[hsla(0,0%,0%,0.8)]!"
          iconName="edit"
        ...
        {artworkPath && (
          <Button
            ...
            className="artwork-delete-btn mr-0! aspect-square rounded-full border-none bg-[hsla(0,0%,0%,0.5)]! outline outline-offset-1 transition-[background]! hover:bg-[hsla(0,0%,0%,0.8)]! focus-visible:outline! dark:bg-[hsla(0,0%,0%,0.5)]! dark:hover:bg-[hsla(0,0%,0%,0.8)]!"
            iconName="delete"
            iconClassName="text-font-color-white dark:text-font-color-white mr-0"
            clickHandler={() =>
              updateSongInfo((prevData) => ({
