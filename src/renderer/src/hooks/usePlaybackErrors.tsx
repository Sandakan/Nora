 ...
 *   prompt and recovery logic.
 * @returns An object with:
 *
 *   - `managePlaybackErrors`: a function accepting an `appError` value to handle the current player
 *     error and attempt recovery or surface a prompt,
    ...
    (appError: unknown) => {
      ...
      const prompt = (
        <ErrorPrompt
          ...
          showSendFeedbackBtn
          onSkipSong={skipSongRef?.current ? () => skipSongRef.current?.() : undefined}
        />
      );
